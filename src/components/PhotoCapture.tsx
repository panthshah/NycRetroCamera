      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-6 max-w-2xl w-full mx-4 shadow-2xl border border-gray-700"
          ...
          >
            ...
            <div className="flex gap-4 justify-center">
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-red-600 hover:bg-red-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white font-semibold rounded-full transition-all transform hover:scale-105 active:scale-95"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-full transition-all transform hover:scale-105 active:scale-95"
              >
